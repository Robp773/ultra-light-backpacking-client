        ...
        return(
                <div className='modalBG'>
                    ...
                    <div className='textImgContainer'>  
                        <img  className='landingImg' src='images/003-clipboard.svg'/> 
                        <div className='text'><h3 className='h3Text'>Plan</h3> your Packing List</div>
                    </div>

                    <div className='textImgContainer'>                         
                        <img  className='landingImg' src='images/002-scissors.svg'/>
                        <div className='text'><h3 className='h3Text'>Cut</h3> Your Weight</div>
                    </div>

                    <div className='textImgContainer'>                         
                        <img  className='landingImg'src='images/001-dove.svg'/>
