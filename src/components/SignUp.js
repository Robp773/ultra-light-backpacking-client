                ...
                <div className='signUpForm'>
                    <h3 className='h3Login'>Sign Up</h3>
                        <form onSubmit={(e)=>{e.preventDefault(); this.onSubmit(this.username.value, this.password.value)}}>
                            <input required className='signUpInput' ref={(input)=>{this.username = input}} name='username' type='text' placeholder='Username'/>
                            <input required className='signUpInput' ref={(input)=>{this.password = input}} name='password' type='text' placeholder='Password'/>
                            <button className='submitLogin' type='submit'>Submit</button>
                        </form>            
